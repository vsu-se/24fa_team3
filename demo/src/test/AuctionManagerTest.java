...
public class AuctionManagerTest {
    ...
    public void testDriver() {
        ...
        addAuction(new Auction("Item1", null, true, false, null, category));  // Owned by user, ended, in category
        addAuction(new Auction("Item2", null, false, true, null, category));  // Ended, not owned by user, in category
        addAuction(new Auction("Item3", null, false, false, null, category)); // Not ended, not owned by user, in category
        addAuction(new Auction("Item4", null, true, true, null, category));   // Owned by user, ended, in category
        addAuction(new Auction("Item5", null, true, false, null, null));      // Owned by user, ended, not in category
        addAuction(new Auction("Item6", null, false, true, null, null));      // Ended, not owned by user, not in category
        addAuction(new Auction("Item7", null, false, false, null, null));     // Not ended, not owned by user, not in category
        addAuction(new Auction("Item8", null, true, true, null, null));       // Owned by user, ended, not in category
